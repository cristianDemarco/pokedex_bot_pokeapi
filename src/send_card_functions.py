...
async def send_pokemon_card(context: ContextTypes.DEFAULT_TYPE, pokemon_card: PokemonCard, chat_id: int, message_id: int, reply_markup: InlineKeyboardMarkup, is_callback: bool):
    message = await context.bot.send_photo(
        chat_id=chat_id,
        caption=translate("CARD_RETURN_MESSAGE", language="IT", data={
